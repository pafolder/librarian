...
public class ProfileController {
    ...
    public User getAuth(@AuthenticationPrincipal UserDetailsImpl authUser) {
        ...
        userWithFutureViolations.setViolations(getFutureViolations(userWithFutureViolations, checkoutRepository));
...
/*    @Transactional*/
    public void updateAuth(@Valid @RequestBody UserTo userTo, @AuthenticationPrincipal UserDetailsImpl authUser,
        ...
        User updated = new User(id, userTo.getName(), userTo.getEmail(), userTo.getPassword(), true,
                0, User.Role.USER);
