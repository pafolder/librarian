...
import static com.pafolder.librarian.infrastructure.controller.admin.AdminBookController.REST_URL;
...
import com.pafolder.librarian.infrastructure.controller.BookTo;
...
public class AdminBookController {
  ...
  @GetMapping()
  @Operation(
      summary = "Get books with Ids between fromId and toId",
            ...
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.UNPROCESSABLE_ENTITY, NO_BOOK_FOR_UPDATE_FOUND));
  ...
  public void delete(@PathVariable int id) {
    ...
    bookRepository
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(
                    HttpStatus.UNPROCESSABLE_ENTITY, NO_BOOK_FOR_DELETION_FOUND));
