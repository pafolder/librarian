...
public class TestData {
  ...
  public static final int BOOK_ID_TO_DELETE = 7;
  public static final String UPDATED_AUTHOR = "Updated Author";
  public static final int UPDATED_BOOK_ID = 1;
  public static final int CREATED_CHECKOUT_ID = 8;
  public static final int CHECKOUT_ID_FOR_CHECKIN = 1;
  public static final int CHECKOUT_ID_TO_DELETE = 7;
  public static final int MAX_ID = Integer.MAX_VALUE;
  public static final String BOOK_ID_FOR_TEST_CHECKOUT = "5";
  ...
  public static final User admin =
      new User(1, "Administrator", ADMIN_MAIL, DEFAULT_ADMIN_PASSWORD, true, 1, User.Role.ADMIN);
  public static final User user =
      new User(2, "User", USER_MAIL, DEFAULT_PASSWORD, true, 0, User.Role.USER);
  public static final User newUser =
      new User(7, "newUser", "newUser@email.com", DEFAULT_PASSWORD, true, 0, User.Role.USER);
  public static Book updatedBook =
      new Book(UPDATED_BOOK_ID, "Updated Author", "Updated Book", "Shelf 1", 0);
