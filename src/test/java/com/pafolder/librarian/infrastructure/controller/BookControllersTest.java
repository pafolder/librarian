...
import static com.pafolder.librarian.infrastructure.controller.admin.AdminBookController.NO_BOOK_FOR_DELETION_FOUND;
import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;

import com.pafolder.librarian.MatcherFactory;
import com.pafolder.librarian.infrastructure.controller.admin.AdminBookController;
import com.pafolder.librarian.infrastructure.controller.profile.BookController;
...
class BookControllersTest extends BaseTestController {
  public static final MatcherFactory.Matcher<Book> BOOK_MATCHER =
      MatcherFactory.usingIgnoringFieldsComparator(Book.class, "amount");
  ...
  void getAllFromIdToId() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get(BookController.REST_URL + "/search")
  ...
  void create() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(AdminBookController.REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                    "{\"author\": \"Created Author\",\"title\": \"Created Book\","
  ...
  void update() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(AdminBookController.REST_URL + "/" + BOOK_ID_FOR_UPDATE)
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void updateNonexistent() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.put(AdminBookController.REST_URL + "/" + NONEXISTENT_ID_STRING)
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"author\": \"" + UPDATED_AUTHOR + "\",\"title\": \"Updated Book\"}"))
        .andDo(print())
        .andExpect(status().isUnprocessableEntity());
  ...
  void delete() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.delete(AdminBookController.REST_URL + "/" + BOOK_ID_TO_DELETE)
                .contentType(MediaType.APPLICATION_JSON))
        .andDo(print())
        .andExpect(status().isNoContent());
