...
import static com.pafolder.librarian.infrastructure.controller.validator.UserToValidator.DUPLICATING_EMAIL;
...
class RegisterControllerTest extends BaseTestController {
  public static final MatcherFactory.Matcher<User> USER_MATCHER =
      MatcherFactory.usingIgnoringFieldsComparator(User.class, "violations", "enabled", "password");
  ...
  void register() throws Exception {
    ResultActions action =
        mockMvc
            .perform(
                MockMvcRequestBuilders.post(RegisterController.REST_URL)
